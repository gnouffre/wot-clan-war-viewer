...
var imgsrc;
var langindex = languages.indexOf(rows[row].cells[13].textContent);
if (langindex == -1) {
...
if (parseInt(rows[row].cells[10].textContent) > 0 || parseInt(rows[row].cells[11].textContent) > 0 || parseInt(rows[row].cells[9].textContent) > 0) {
